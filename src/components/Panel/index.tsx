...
import {Collapse, CollapsePanel, PageHeader} from "ant-design-vue";
...
import {customTranslate} from "@/components/Designer/config/modules/Translate";
    ...
    setup() {
        ...
        return () => (
            <div>
                ...
                {!!currentElement.value && <Collapse ghost accordion>
